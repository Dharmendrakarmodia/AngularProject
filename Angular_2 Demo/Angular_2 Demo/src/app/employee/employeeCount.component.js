...
var employeeCountComponent = (function () {
    function employeeCountComponent() {
        ...
        this.countradiobuttonselected = new core_1.EventEmitter();
    }
    employeeCountComponent.prototype.onRadioButton = function () {
...
], employeeCountComponent.prototype, "countradiobuttonselected", void 0);
__decorate([
    core_1.Input(),
